...
def get_visual_data_few_days_weather(data_list: list):
    ...
    for dict_item in data_list:
        ...
        if len(str(dict_item['description'])) > 25:
            dict_item['description'] = str(dict_item['description']).replace('light ','').replace('heavy ','')
        if '09:00' in dict_item['dt'] or '15:00' in dict_item['dt'] or '21:00' in dict_item['dt']: # or
